        ...
        <>
           <div className={'flex justify-between w-full px-4'}>
               ...
               <div className={'flex items-center gap-3'}>
                   <Dialog>
                       <DialogTrigger>
                           <div className={'text-[14px] text-white bg-[#246BFD] rounded-l-full rounded-r-full py-[10px] px-[24px]'}>Ajouter une organisation</div>
                       </DialogTrigger>
                       <DialogContent className={'px-[40px] py-[40px] w-[624px]'}>
                           <DialogHeader>
                               <DialogTitle className={'text-center mb-[40px]'}>Ajouter une organisation</DialogTitle>
                               ...
                               <div className={'flex mx-auto'}>
                                   <form action="" className={'flex flex-col gap-[40px]'}>
                                       ...
                                       <div className={'flex justify-center'}>
                                           <button type={"submit"} className={'font-600 text-16 justify-center text-white bg-blue-500 w-[240px] h-[40px] rounded rounded-l-full rounded-r-full'}>Ajouter une organisation</button>
                                       </div>
                                   </form>
                               </div>
